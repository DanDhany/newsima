...
{
    /**
     * @var array<int, int> Map dari ID member lama ke ID member baru.
     */
    ...
    public function run(): void
    {
        ...
        foreach ($oldMembers as $member) {
            // Kita asumsikan ID bidang tidak berubah karena sudah di-seed dari data statis
            // Jika ID bidang juga berubah, perlu mapping dari OldMasterBidangSeeder
